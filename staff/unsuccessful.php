...
$sql = mysqli_query($connection, "SELECT * FROM tbl_transaction WHERE status = 'Unsuccessful'");
...
if (mysqli_num_rows($sql) > 0) {
    while ($rows = mysqli_fetch_array($sql)) {
        ...
        $statusStyle = ($rows['status'] == 'Unsuccessful') ? 'background-color: red; color: white; border-radius: 5px; padding: 2px 5px;' : '';
